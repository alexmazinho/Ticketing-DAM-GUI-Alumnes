package ins.marianao.ticketing.fxml.manager;
...
import ins.marianao.ticketing.fxml.ControllerMenu;
...
public class ResourceManager {
	...
	public static final String FILE_REPORT_TICKETS = "tickets_report.pdf";
	...
	/**
	 * REST client (jersey) with configurations: JSON (jackson) + SSL suport using ticketingws KeyStore as trustStore
	 * 
	 * @return REST client 
	 * @throws Exception
	 */
