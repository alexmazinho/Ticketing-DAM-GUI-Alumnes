...
import ins.marianao.ticketing.fxml.services.ServiceLogin;
...
public class ControllerMenu implements Initializable {
	...
	@FXML private Menu mnTickets;
	@FXML private Menu mnUsers;
	@FXML private Menu mnProfile;
	@FXML private MenuItem mnItOpenTicket;
	...
	/**
	 * Called when Open ticket menuItem is fired.
	 *
	 * @param event the action event.
	 */
	@FXML
	public void openTicketMenuClick(ActionEvent event) {
		/* ToDo */
	}

	/**
	 * Called when Tickets pending menuItem is fired.
	 *
	 * @param event the action event.
	 */
	@FXML
	public void ticketsPendingMenuClick(ActionEvent event) {
		/* ToDo */
	}

	/**
	 * Called when Tickets in process menuItem is fired.
	 *
	 * @param event the action event.
	 */
	@FXML
	public void ticketsInProcessMenuClick(ActionEvent event) {
		/* ToDo */
	}

	/**
	 * Called when Tickets history menuItem is fired.
	 *
	 * @param event the action event.
	 */
	@FXML
	public void ticketsHistoryMenuClick(ActionEvent event) {
		/* ToDo */
	}
	...
	public void exportUsersMenuClick(ActionEvent event) {
		try {
			...
			if (file != null) {
				final ServiceQueryUsers queryUsers = new ServiceQueryUsers(0, 10, "username", SortDirection.SORT_ASC, null, null);
	...
	private void enableMenu(User usuari) {
		this.mnTickets.setVisible(true);
		this.mnUsers.setVisible(true);
		this.mnProfile.setVisible(true);
		
		/*this.menuBar.getMenus().add(1, this.mnTickets);
		this.menuBar.getMenus().add(2, this.mnUsers);
		this.menuBar.getMenus().add(3, this.mnProfile);*/
		
		if (usuari != null) {
			if (usuari.isEmployee()) this.mnItOpenTicket.setDisable(false);
